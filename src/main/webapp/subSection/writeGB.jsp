...
<html>
 ...
 <body>
	<!--| ***body StarT*** |-->
		...
		style="width: 70%; " id="id_div_writeGbPanel">
			<div class="w3-container w3-bar w3-white" id="id_div_GbCloser">
				<h2 class="w3-bar-item">방명록 작성하기...</h2>
